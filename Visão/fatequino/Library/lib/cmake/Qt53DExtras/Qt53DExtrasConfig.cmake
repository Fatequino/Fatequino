...
if (NOT TARGET Qt5::3DExtras)
    ...
    _populate_3DExtras_target_properties(RELEASE "Qt53DExtras_conda.dll" "Qt53DExtras_conda.lib" )

    if (EXISTS
        "${_qt53DExtras_install_prefix}/bin/Qt53DExtras_condad.dll"
      AND EXISTS
        "${_qt53DExtras_install_prefix}/lib/Qt53DExtras_condad.lib" )
        _populate_3DExtras_target_properties(DEBUG "Qt53DExtras_condad.dll" "Qt53DExtras_condad.lib" )
    endif()
