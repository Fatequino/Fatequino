...
if (NOT TARGET Qt5::Location)
    ...
    _populate_Location_target_properties(RELEASE "Qt5Location_conda.dll" "Qt5Location_conda.lib" )

    if (EXISTS
        "${_qt5Location_install_prefix}/bin/Qt5Location_condad.dll"
      AND EXISTS
        "${_qt5Location_install_prefix}/lib/Qt5Location_condad.lib" )
        _populate_Location_target_properties(DEBUG "Qt5Location_condad.dll" "Qt5Location_condad.lib" )
    endif()
