...
if (NOT TARGET Qt5::OpenGLExtensions)
    ...
    _populate_OpenGLExtensions_target_properties(RELEASE "Qt5OpenGLExtensions_conda.lib" "" )

    if (EXISTS "${_qt5OpenGLExtensions_install_prefix}/lib/Qt5OpenGLExtensions_condad.lib" )
        _populate_OpenGLExtensions_target_properties(DEBUG "Qt5OpenGLExtensions_condad.lib" "" )
    endif()
