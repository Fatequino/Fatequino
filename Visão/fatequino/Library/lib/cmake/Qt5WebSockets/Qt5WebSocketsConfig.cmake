...
if (NOT TARGET Qt5::WebSockets)
    ...
    _populate_WebSockets_target_properties(RELEASE "Qt5WebSockets_conda.dll" "Qt5WebSockets_conda.lib" )

    if (EXISTS
        "${_qt5WebSockets_install_prefix}/bin/Qt5WebSockets_condad.dll"
      AND EXISTS
        "${_qt5WebSockets_install_prefix}/lib/Qt5WebSockets_condad.lib" )
        _populate_WebSockets_target_properties(DEBUG "Qt5WebSockets_condad.dll" "Qt5WebSockets_condad.lib" )
    endif()
