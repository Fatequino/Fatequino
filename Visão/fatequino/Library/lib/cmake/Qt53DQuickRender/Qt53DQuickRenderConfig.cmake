...
if (NOT TARGET Qt5::3DQuickRender)
    ...
    _populate_3DQuickRender_target_properties(RELEASE "Qt53DQuickRender_conda.dll" "Qt53DQuickRender_conda.lib" )
    ...
    if (EXISTS
      ...
      AND EXISTS
        ...
        _populate_3DQuickRender_target_properties(DEBUG "Qt53DQuickRender_condad.dll" "Qt53DQuickRender_condad.lib" )
    endif()
