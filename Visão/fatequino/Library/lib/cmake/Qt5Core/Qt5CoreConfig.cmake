...
if (NOT TARGET Qt5::Core)
    ...
    _populate_Core_target_properties(RELEASE "Qt5Core_conda.dll" "Qt5Core_conda.lib" )

    if (EXISTS
        "${_qt5Core_install_prefix}/bin/Qt5Core_condad.dll"
      AND EXISTS
        "${_qt5Core_install_prefix}/lib/Qt5Core_condad.lib" )
        _populate_Core_target_properties(DEBUG "Qt5Core_condad.dll" "Qt5Core_condad.lib" )
    endif()
