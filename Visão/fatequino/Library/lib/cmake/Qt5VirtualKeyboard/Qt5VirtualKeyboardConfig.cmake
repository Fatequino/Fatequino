...
if (NOT TARGET Qt5::VirtualKeyboard)
    ...
    _populate_VirtualKeyboard_target_properties(RELEASE "Qt5VirtualKeyboard_conda.dll" "Qt5VirtualKeyboard_conda.lib" )
    ...
    if (EXISTS
      ...
      AND EXISTS
        ...
        _populate_VirtualKeyboard_target_properties(DEBUG "Qt5VirtualKeyboard_condad.dll" "Qt5VirtualKeyboard_condad.lib" )
    endif()
