...
if (NOT TARGET Qt5::Bluetooth)
    ...
    _populate_Bluetooth_target_properties(RELEASE "Qt5Bluetooth_conda.dll" "Qt5Bluetooth_conda.lib" )

    if (EXISTS
        "${_qt5Bluetooth_install_prefix}/bin/Qt5Bluetooth_condad.dll"
      AND EXISTS
        "${_qt5Bluetooth_install_prefix}/lib/Qt5Bluetooth_condad.lib" )
        _populate_Bluetooth_target_properties(DEBUG "Qt5Bluetooth_condad.dll" "Qt5Bluetooth_condad.lib" )
    endif()
