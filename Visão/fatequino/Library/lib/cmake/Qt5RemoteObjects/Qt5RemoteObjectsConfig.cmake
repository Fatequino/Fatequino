...
if (NOT TARGET Qt5::RemoteObjects)
    ...
    _populate_RemoteObjects_target_properties(RELEASE "Qt5RemoteObjects_conda.dll" "Qt5RemoteObjects_conda.lib" )
    ...
    if (EXISTS
      ...
      AND EXISTS
        ...
        _populate_RemoteObjects_target_properties(DEBUG "Qt5RemoteObjects_condad.dll" "Qt5RemoteObjects_condad.lib" )
    endif()
